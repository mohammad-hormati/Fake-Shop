...
function Products() {
    ...
    const filterProduct = (cat) => {
        const newList = data.filter((item) => item.category === cat);
        setFilter(newList);
    }
    ...
    const ShowProducts = () => {
        return(
            <>
                <div className="buttons d-flex justify-content-center btn-res mb-5 pb-5">
                    <button className="btn btn-outline-dark " onClick={() => setFilter(data)} >All</button>
                    <button className="btn btn-outline-dark  ms-2" onClick={() => filterProduct("men's clothing")} >Men's Clothins</button>
                    <button className="btn btn-outline-dark  ms-2" onClick={() => filterProduct("women's clothing")} >Women's Clothins</button>
